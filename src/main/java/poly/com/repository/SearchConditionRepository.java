...
public interface SearchConditionRepository extends JpaRepository<SearchCondition, Integer> {
    ...
    Integer getTopTypeOfRoom(@Param("sid") String sid);
    ...
    Integer getTopProvince(@Param("sid") String sid);
    ...
    Integer getTopAcreageMin(@Param("sid") String sid);
    ...
    Integer getTopacreageMax(@Param("sid") String sid);
}
